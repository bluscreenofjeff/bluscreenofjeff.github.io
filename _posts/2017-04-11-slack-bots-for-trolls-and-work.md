...
>Update 4/25/17: It's important to note that you will be sending potentially sensitive information to Slack, such as usernames, target IPs, target hostnames, and teamserver info. Be sure to review the code and make modifications to the code to eliminate unwanted sensitive information from going to Slack if you plan to use this on a production test.
